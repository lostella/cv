...
%\subtitle{GitHub profile: \href{\mygithubURL}{\mylink{link}}}
}
...
Proximal Algorithms.jl	& Generic, efficient \lang{Julia}\ implementations of proximal algorithms for nonsmooth optimization problems, based on the first-order primitives provided by ProximalOperators.jl.\spacednewline
			& Web page: \href{https://github.com/kul-forbes/ProximalAlgorithms.jl}{\myurl{github.com/kul-forbes/ProximalAlgorithms.jl}}\spacednewline
